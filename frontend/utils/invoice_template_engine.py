...
class InvoiceTemplateEngine:
    ...
    def _get_styles(self) -> str:
        ...
        return f"""
            <style>
                body {{ font-family: 'Segoe UI', Arial, sans-serif; margin: 0; padding: 20px; font-size: 12px; color: {colors['text']}; background: {colors['background']}; }}
                .header {{ background-color: {colors['primary']}; color: white; padding: 20px; border-radius: 5px; position: relative; }}
                ...
                td {{ padding: 8px 10px; border-bottom: 1px solid #ddd; word-wrap: break-word; overflow: hidden; }}
                .col-id {{ width: 30px; }}
                ...
                .grand-total {{ font-size: 16px; font-weight: bold; background-color: {colors['primary']}; color: white; }}
    ...
    def _render_standard(self, inv: Dict[str, Any], company: Dict[str, Any]) -> str:
        ...
        html += f"""
            ...
            <div class="footer">
                ...
                <p style="font-size: 8px;">Generated by Pharmacy ERP</p>
            </div>
        </body>
        </html>
        """
    ...
    def _render_qr_section(self, inv: Dict[str, Any]) -> str:
        ...
        # in production this should be generated locally.
        qr_data = f"INV:{inv.get('invoice_number')}|AMT:{inv.get('total_amount')}"
        qr_url = f"https://api.qrserver.com/v1/create-qr-code/?size=80x80&data={qr_data}"
        return f"""
            <div class="qr-code">
                <img src="{qr_url}" alt="QR Code" width="80" height="80">
    ...
    def _render_compact(self, inv: Dict[str, Any], company: Dict[str, Any]) -> str:
        ...
        <head>
            <style>
                body {{ font-family: 'Courier New', monospace; padding: 0; margin: 0; font-size: 11px; width: 280px; color: #000; }}
                .center {{ text-align: center; }}
                .bold {{ font-weight: bold; }}
                .header-line {{ font-size: 14px; margin-bottom: 2px; }}
        ...
        html += f"""
            ...
            <div class="totals">
                ...
                <div class="bold" style="display: flex; justify-content: space-between; font-size: 13px; margin-top: 2px;">
                    <span>TOTAL:</span>
            ...
            <div class="center" style="margin-top: 10px;">
                ...
                { self._render_qr_section(inv) if self.config.get('show_qr') else "" }
                <div style="font-size: 8px; margin-top: 5px;">Powered by Pharmacy ERP</div>
            </div>
        </body>
        </html>
        """
