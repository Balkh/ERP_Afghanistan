...
class APIClient(QObject):
    ...
    def _make_request(self, method: str, endpoint: str, 
        ...
        try:
            ...
            # Debug logging
            if DEBUG_MODE:
                print(f"[API] Response keys: {list(response_data.keys()) if isinstance(response_data, dict) else type(response_data)}")
    ...
    def get(self, endpoint: str, params: Optional[Dict] = None, 
        ...
        print(f"GET {endpoint} failed after {retries} attempts: {last_error}")
