...
class StateHelper:
    ...
    def show_loading(self, message: str = STATE_LOADING):
        ...
        spinner.setFont(QFont("Segoe UI", TEXT_CARD_TITLE))
        ...
        # Message
        msg = QLabel(message)
        msg.setFont(QFont("Segoe UI", TEXT_BODY))
    ...
    def show_empty(
        ...
        title_label.setFont(QFont("Segoe UI", TEXT_BODY, QFont.Weight.Bold))
        ...
        if subtitle:
            sub = QLabel(subtitle)
            sub.setFont(QFont("Segoe UI", TEXT_BODY_SMALL))
