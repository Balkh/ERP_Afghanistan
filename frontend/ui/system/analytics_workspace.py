...
class AnalyticsWorkspace(BaseScreen):
    ...
    def _setup_screen(self):
        ...
        tabs = QTabWidget()
        tabs.addTab(SystemIntegrityScreen(api_client=self._init_api_client), "System Integrity")
        tabs.addTab(WorkflowIntelligenceScreen(api_client=self._init_api_client), "Workflow Intelligence")
        tabs.addTab(DriftIntelligenceScreen(api_client=self._init_api_client), "Drift Detection")
        tabs.addTab(SystemCorrelationScreen(api_client=self._init_api_client), "Correlation")
        tabs.addTab(EventStoreScreen(api_client=self._init_api_client), "Event Store")
        tabs.addTab(AnomalyInvestigationScreen(api_client=self._init_api_client), "Anomaly Investigation")
        tabs.addTab(EventInvestigationScreen(api_client=self._init_api_client), "Event Investigation")
