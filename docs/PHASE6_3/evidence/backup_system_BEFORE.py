...
class BackupManager:
    ...
    def create_backup(self, db_path: str = None, include_files: List[str] = None,
        ...
        Body extracted to backup.extracts.create_backup_workflow for clarity.
        Public method signature, return payload, exceptions, and side
        effects are byte-identical to the pre-refactor implementation.
        """
    ...
    def restore_backup(self, backup_path: str, target_db_path: str = None,
        ...
        Body extracted to backup.extracts.restore_backup_workflow for clarity.
        Public method signature, return payload, exceptions, and side
        effects are byte-identical to the pre-refactor implementation.
        """
        from backup.extracts.restore_backup_workflow import run
        return run(self, backup_path, target_db_path, password, verify)
