...
class SalesItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'dispensed_quantity', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'total', 'batch_number', 'created_at', 'updated_at']
        extra_kwargs = {
...
class SalesInvoiceSerializer(serializers.ModelSerializer):
    ...
    writable_items = SalesItemSerializer(many=True, required=False, write_only=True)
    ...
    def get_workflow_status(self, obj):
        ...
        status = WorkflowService.get_workflow_status('SALES_INVOICE', obj.id)
        return status
